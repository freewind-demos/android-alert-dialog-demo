...
public final class DialogCustomBinding implements ViewBinding {
  ...
  private DialogCustomBinding(@NonNull LinearLayout rootView, @NonNull TextInputEditText emailInput,
  ...
  public static DialogCustomBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogCustomBinding((LinearLayout) rootView, emailInput, nameInput);
    }
